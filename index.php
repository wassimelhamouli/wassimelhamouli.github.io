...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-heading text-uppercase">El hamouli Wassim</div>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img" id="card-container">
                                            <img src="assets/img/IMG_2619.JPG" class="img-fluid rounded b-shadow-a" alt="" id="card">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
                                        <div class="about-info">
                                            <p><span class="title-s">Nom/Prénom: </span> <span>El hamouli Wassim</span>
                                            </p>
                                            <p><span class="title-s">Profil: </span> <span>Développeur et footballeur   
                                                </span>
                                            </p>
                                            <p><span class="title-s">Email: </span> <span><a href="mailto:Wassim8744@gmail.com">Wassim8744@gmail.com</a>
                                                </span>
                                            </p>
                                            <p><span class="title-s">Téléphone: </span> <span>0767066148</span></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="about-me pt-4 pt-md-0">
                                    ...
                                    <p class="lead">
                                        Je suis El hamouli Wassim, étudiant en deuxieme année de BTS SIO (Services
                                        Informatiques aux Organisations), Option SLAM
                                        (Solutions Logicielles et Application Métier) l'option spécialisée pour le
                                        développement, au lycée Valadon à Limoges.
                                    </p>
                                    <p class="lead">
                                        J'ai développé une passion pour l'informatique depuis que j'ai effectué mon stage de 3eme en entreprise. C'est ainsi que j'ai
                                        découvert le développement web et j'ai décider d'en faire mon futur métier.

                                    </p>
                                    <p class="lead">
                                        En dehors de ma passion pour le développement web, je pratique du Football
                                        semi-professionnel à un niveau national à Panazol.
                                    </p>
                                    <p class="lead">
                            ...
                            <div>
                                ...
                                <div class="skill-mf"><br><br>
                                    ...
                                    <div>
                                        ...
                                        <span>Anglais</span> <span class="pull-right">65%</span>
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: 65%;" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="skill-mf"><br><br>
                                    ...
                                    <div>
                                        ...
                                        <span>Wix</span> <span class="pull-right">50%</span>
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar" style="width: 50%;" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="cv_btn">
                                    <a class="btn btn-primary btn-xl text-xl-center " href="assets/lien/CV_El_hamouli_Wassim.pdf" target="_blank">Retrouvez mon CV ici &ensp;<img src="assets/img/icon/pdf.svg" alt="" width="10%"></a>
                                </div>
                            </div><br> <br><br>
                        </div>
                    </div>
